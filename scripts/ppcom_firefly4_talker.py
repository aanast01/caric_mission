...
if __name__ == '__main__':
    ...
    rospy.init_node('firefly4_talker', anonymous=False)
    ...
    response = create_ppcom_topic('firefly4', ['all'], '/ping_message', 'std_msgs', 'String')
    print(f"Response {response}")

    # Create the publisher
    msg_pub = rospy.Publisher('/ping_message', String, queue_size=1)
    ping_message_sub = rospy.Subscriber('/ping_message/firefly4', String, PingMessageCallback)
